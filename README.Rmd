...
The purpose of the R package `surfcov` is to enable covariance estimation for random surfaces beyond separability, proposed in the papers [arXiv:1912.12870](https://arxiv.org/abs/1912.12870) and [arXiv:2007.12175](https://arxiv.org/abs/2007.12175).
...
1. the separable-plus-banded model: \[ C[i,j,i',j'] = A_1[i,i'] A_2[j,j'] + B[i,j,i',j'] \], where \[ B[i,j,i',j'] = 0 \] for \[|i-i'| > d \] or \[ |j-j'| > d \];
